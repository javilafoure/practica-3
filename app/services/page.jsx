      ...
      <div className='flex justify-center py-20 gap-5'>
        <div className='flex flex-col w-80 h-96 border rounded-lg shadow px-8 py-4 gap-5'>
          <div className='flex justify-center py-11'>
            <img className='h-28 w-28' src="services/icon1.png" alt="" />
          </div>
        ...
        <div className='flex flex-col w-80 h-96 border rounded-lg shadow px-8 py-4 gap-5'>
          <div className='flex justify-center py-11'>
            <img className='h-28 w-28' src="services/icon2.png" alt="" />
          </div>
        ...
        <div className='flex flex-col w-80 h-96 border rounded-lg shadow px-8 py-4 gap-5'>
          <div className='flex justify-center py-11'>
            <img className='h-28 w-28' src="services/icon3.png" alt="" />
          </div>

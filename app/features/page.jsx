    ...
    <div className='flex flex-col justify-center'>
      ...
      <div className='flex flex-col py-14'>
        <div className='flex justify-center px-3 gap-3'>
          <div className='flex flex-col w-80 h-48 py-4 gap-2'>
            <div className='flex justify-center py-4'>
              <img className='w-24 h-24' src="features/icon1.png" alt="" />
            </div>
          ...
          <div className='flex flex-col w-80 h-48 py-4 gap-2'>
            <div className='flex justify-center py-4'>
              <img className='w-24 h-24' src="features/icon2.png" alt="" />
            </div>
          ...
          <div className='flex flex-col w-80 h-48 py-4 gap-2'>
            <div className='flex justify-center py-4'>
              <img className='w-24 h-24' src="features/icon3.png" alt="" />
            </div>
        ...
        <div className='flex justify-center py-10 gap-3'>
          <div className='flex flex-col w-80 h-48 py-4 gap-2'>
            <div className='flex justify-center py-4'>
              <img className='w-24 h-24' src="features/icon4.png" alt="" />
            </div>
          ...
          <div className='flex flex-col w-80 h-48 py-4 gap-2'>
            <div className='flex justify-center py-4'>
              <img className='w-24 h-24' src="features/icon5.png" alt="" />
            </div>
          ...
          <div className='flex flex-col w-80 h-48 py-4 gap-2'>
            <div className='flex justify-center py-4'>
              <img className='w-24 h-24' src="features/icon6.png" alt="" />
            </div>

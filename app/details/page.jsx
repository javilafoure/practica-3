      ...
      <div className='flex flex-col py-14'>
        <div className='flex justify-center py-10 gap-11'>
          <div className='w-96 h-80'>
            <img src="details/illustration3.png" alt="" />
          </div>
          <div className='flex flex-col w-96 h-80 py-5 px-3 gap-3'>
            ...
            <p className='text-left text-slate-400'>Today, Id like to show you some incredible Sign Up screen app UI ideas and concepts that offer a modern user experience.
        ...
        <div className='flex justify-center py-10 gap-11'>
          ...
          <div className='w-96 h-80 '>
            <img src="details/illustration6.png" alt="" />
          </div>

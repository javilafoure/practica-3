      ...
      <div className='flex flex-col py-14'>
        <div className='flex justify-center px-3 gap-8'>
          ...
          <div className='flex flex-col w-96 h-80 p-3 gap-3'>
            ...
            <h3 className='text-left text-slate-400'>I just wanted to drop you a little email to say thank you for all your hard work. I'm delighted I chose you as my partner. Your websites are quite simple to edit and maintain, which is fantastic.</h3>
            <div className='flex'>
